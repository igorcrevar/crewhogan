/**
 * Exports function
 * @param {String|Object} not mandatory, if String - base directory for templates, if object than it should be list of options { baseDir: '', aliases: {}}
	...
	function getTemplate(name, partials) {
		...
		if (!cached) {
			...
			if (index != -1) {
				...
				templateName = name.substring(index);
